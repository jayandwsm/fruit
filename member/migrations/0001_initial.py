    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(default='1.jpg', max_length=300, upload_to='static/image/goods', verbose_name='商品图片')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc', models.CharField(default='商品描述', max_length=200, verbose_name='商品描述')),
                ('isdelete', models.BooleanField(default=False, verbose_name='删除')),
            ],
        ),
        migrations.AddField(
            model_name='goods',
            name='type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='member.GoodsType'),
        ),
    ]
